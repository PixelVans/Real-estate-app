...
//HANDLE CHANGE FROM INPUTS
    const handleChange = (e) => {
        ...
        if (e.target.type === 'number' || e.target.type === 'text' || e.target.type === 'textarea') {
            setFormData({
                ...formData,
                [e.target.id]: e.target.value // Updates the corresponding field with new value
            });
}
 }
  ...
  return (
      <main className='p-3 max-w-4xl mx-auto'>
          ...
          <form onSubmit={handleSubmit}
             ...
             uppercase hover:opacity-85 disabled:opacity-75'>{loading ? 'Updating...' : 'Update This Listing'}</button>
